...
- Convert the matrix to a dataset and create a `coefplot`-style graph showing the point estimate ± 95% CI at each bandwidth. Add a horizontal reference line at zero.
...
2\. Export the figure and import it into your Overleaf document.
