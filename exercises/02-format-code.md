...
[This script]({{ site.baseurl }}/code/bad-style.do), which evaluates the number of diary entries made over time by treatment and control households in a [solar stove field experiment]](https://doi.org/10.1111/ajae.70026) that I ran, doesn't follow good style. *It works, but it's difficult to understand exactly what it is doing.* 

- Download [the script]({{ site.baseurl }}/code/bad-style.do). 
