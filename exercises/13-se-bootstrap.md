...
- Run the bootstrap regression on `lifeexp.dta` (this may take a few seconds):
...
1. How do the standard errors compare to the computationally derived HC2 model from the previous exercise? Are the bootstrapped standard errors tighter or wider?
