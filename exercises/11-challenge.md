...
This challenge combines everything you've learned about Fixed Effects, `estout`, and `coefplot` to test the sensitivity of the `irrig` coefficient across multiple Fixed Effect specifications.
- Load the `tenuredata.dta` dataset.
