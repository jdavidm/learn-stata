...
[This script]({{ site.baseurl }}/code/bad-style-R.R), which evaluates [tree composition in a Michigan swamp](https://esapubs.org/archive/ecol/E090/251/default.htm), doesn't follow 
