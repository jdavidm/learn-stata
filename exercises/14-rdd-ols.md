...
- Export a three-column table to LaTeX:
...
1\. Interpret the coefficient on `t` in the unweighted fires regression. What does it mean substantively?

2\. How does adding kernel weights change the estimate? Why might this happen?
