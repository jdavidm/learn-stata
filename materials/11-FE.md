...
By regressing the change in yield on the change in fertilizer, we purge any omitted variable bias that is constant over time. Economists call this approach to identification as ``identifying off of within-in variation.''
...
While LSDV is mathematically identical to the within-transformation, it is computationally intensive. If you have 5,000 households, Stata has to estimate 5,000 parameters! This will often exceed the matrix limits of your Stata version or take a very long time to run.
