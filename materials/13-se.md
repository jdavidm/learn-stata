...
Anderson's procedure is implemented via a standalone do-file ([`fdr_sharpened_qvalues.do`]({{ site.baseurl }}/code/fdr_sharpened_qvalues.do)) rather than a Stata package. It takes a variable of *p*-values as input:
...
> Do [Exercise 9 - Multiple Hypothesis Testing]({{ site.baseurl }}/exercises/13-se-mht/)
