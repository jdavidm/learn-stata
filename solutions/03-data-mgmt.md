...
2. [Label Variables]({{ site.baseurl }}/solutions/03-lab-var.txt)
4. [Label Values]({{ site.baseurl }}/solutions/03-lab-val.txt)
...
5. [Merge Data]({{ site.baseurl }}/solutions/03-merge-data.txt)
6. [Check That Your Code Runs]({{ site.baseurl }}/solutions/check-that-your-code-runs.gif)
7. [Challenge 3]({{ site.baseurl }}/solutions/03-challenge.png)