...
1. [Load or Download File]({{ site.baseurl }}/solutions/02-load-or-download-file.txt)
2. [Format the Code]({{ site.baseurl }}/solutions/02-format-code.png)
2. [Basic If Statements]({{ site.baseurl }}/solutions/02-basic-if.txt)
