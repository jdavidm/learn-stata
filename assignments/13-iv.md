...
language: Stata
exercises: ['Manual 2SLS', 'Using `ivreg2`', 'Panel IV with `xtivreg2`', 'Instrument Diagnostics', 'Robust Standard Errors', 'Bootstrap Comparisons', 'Wild Cluster Bootstrap', 'Randomization Inference', 'Check That Your Code Runs', 'Challenge 13']
